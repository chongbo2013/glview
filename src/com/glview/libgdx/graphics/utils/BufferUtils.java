...
public class BufferUtils {
	 ...
	 * @param dst the destination Buffer, its position is used as an offset.
	 * @param numElements the number of elements to copy. */
	public static void copy (short[] src, int srcOffset, ShortBuffer dst, int numElements) {
		dst.clear();
		dst.put(src, srcOffset, numElements);
		dst.flip();
	}
	 ...
	 * @param dst the destination Buffer, its position is used as an offset.
	 * @param numElements the number of elements to copy. */
	public static void copy (char[] src, int srcOffset, CharBuffer dst, int numElements) {
		dst.clear();
		dst.put(src, srcOffset, numElements);
		dst.flip();
	}
	 ...
	 * @param dst the destination Buffer, its position is used as an offset.
	 * @param numElements the number of elements to copy. */
	public static void copy (int[] src, int srcOffset, IntBuffer dst, int numElements) {
		dst.clear();
		dst.put(src, srcOffset, numElements);
		dst.flip();
	}
	 ...
	 * @param dst the destination Buffer, its position is used as an offset.
	 * @param numElements the number of elements to copy. */
	public static void copy (long[] src, int srcOffset, LongBuffer dst, int numElements) {
		dst.clear();
		dst.put(src, srcOffset, numElements);
		dst.flip();
	}
	 ...
	 * @param dst the destination Buffer, its position is used as an offset.
	 * @param numElements the number of elements to copy. */
	public static void copy (float[] src, int srcOffset, FloatBuffer dst, int numElements) {
		dst.clear();
		dst.put(src, srcOffset, numElements);
		dst.flip();
	}
	 ...
	 * @param dst the destination Buffer, its position is used as an offset.
	 * @param numElements the number of elements to copy. */
	public static void copy (double[] src, int srcOffset, DoubleBuffer dst, int numElements) {
		dst.clear();
		dst.put(src, srcOffset, numElements);
		dst.flip();
	}
...
//		buffer.order(ByteOrder.nativeOrder());
		ByteBuffer buffer = newByteBuffer(numBytes);
